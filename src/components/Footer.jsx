  ...
  return (
    <footer className="bg-neutral-950 border-t border-neutral-900 text-neutral-400 py-12 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
        ...
        {/* Columna 1: Info con Logo & Ubicación */}
        <div className="space-y-3">
          ...
          <p className="text-sm text-neutral-400">
            Tattoo Studio profesional. Arte exclusivo y personalizado en la Isla de Margarita 🌴, Venezuela 🇻🇪.
          </p>
          <p className="text-xs text-neutral-500 pt-1">
            Lic. Artes / Diseño Gráfico &bull; Estándares estrictos de bioseguridad.
          </p>
        </div>
